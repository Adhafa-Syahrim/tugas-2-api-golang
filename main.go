...
func weatherForecastHandler(c echo.Context) error {
	apiKey := "cc0a364fa16d48d0941135837230311" // kunci api WeatherAPI.com 
...
func main() {
	...
	// Definisikan rute untuk menangani permintaan cuaca
	e.GET("/weather", weatherForecastHandler)

	// Rute untuk menampilkan halaman web
	e.GET("/web", webHandler) 

	// Jalankan server Echo
	port := 8080 // Pilih port yang sesuai
